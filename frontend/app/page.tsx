...
import { ArrowRight, Code, Smartphone, Check, MessageCircle } from "lucide-react"
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-pretty text-lg text-primary-foreground/90 sm:text-xl">
                Custom Websites & Mobile Apps for Indian Businesses
              </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="group transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  Starting from <span className="text-primary">₹8,000</span>
                  </div>
